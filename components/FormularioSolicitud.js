// components/FormularioSolicitud.js
...
export default function FormularioSolicitud({ onClose, onSuccess }) {
  ...
  const handleEnviar = async () => {
    ...
    fechaHoraFin.setHours(horaFin.getHours());
    fechaHoraFin.setMinutes(horaFin.getMinutes());
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.timeContainer}>
            <TouchableOpacity 
              style={[styles.datetimeInput, { flex: 1, marginRight: 10 }]}
